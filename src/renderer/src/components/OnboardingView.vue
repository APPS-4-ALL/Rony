...
const engineStepValid = (): boolean =>
  defaultEngine.value === 'deterministic' || aiConsent.value
  ...
  >
    ...
    <template v-if="step === 3">
      <div class="w-full max-w-md">
            ...
            <div class="flex items-start justify-between gap-4">
              <div>
                ...
                <p class="mt-1 text-xs text-slate-500">
                  ...
                  המסמך ישירות מאתר הספק. כבוי כברירת מחדל כי פעולה זו יוצרת תקשורת עם שרתי
                  צד שלישי.
                </p>
              </div>
              <button
        ...
        <p class="mt-4 text-xs text-slate-600">ניתן לשנות הגדרות אלו בכל עת דרך לשונית ההגדרות.</p>
        ...
        <div class="mt-6 grid gap-3 sm:grid-cols-2">
          ...
          >
            <div class="flex items-center justify-between">
              ...
              <span v-if="defaultEngine === 'deterministic'" class="text-xs font-semibold text-emerald-400">נבחר</span>
            </div>
          ...
          >
            <div class="flex items-center justify-between">
              ...
              <span v-if="defaultEngine === 'ai'" class="text-xs font-semibold text-emerald-400">נבחר</span>
            </div>
            <p class="mt-2 text-xs text-slate-400">
          ...
          <div v-if="aiConsent">
            ...
            <div class="flex flex-wrap gap-2">
              <button
                ...
                "
                @click="aiProvider = p.value; apiKeySaved = false; apiKeyInput = ''"
              >
                {{ p.label }}
              </button>
            </div>
            ...
            <div class="mt-4">
              <p class="mb-1.5 text-sm font-medium text-slate-300">
                ...
                <span class="mr-1 text-xs font-normal text-slate-500">(ניתן להוסיף מאוחר יותר)</span>
              </p>
              ...
              <p v-if="apiKeySaved" class="mt-1.5 text-xs text-emerald-400">✓ המפתח נשמר בצורה מאובטחת.</p>
    ...
    <template v-if="step === 5">
      <div class="w-full max-w-md">
        ...
        <div v-if="authStatus.connected" class="mt-6 border border-emerald-500/40 bg-emerald-500/5 p-4">
